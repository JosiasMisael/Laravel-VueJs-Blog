...
Vue.component('post-header', require('./components/Header.vue').default);
Vue.component('post-tag', require('./components/Tags.vue').default);
...
Vue.component('disqus-comments', require('./components/DisqusComents.vue').default);
